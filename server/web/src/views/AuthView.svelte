...
<style>
  .auth-section { flex:1; display:flex; align-items:center; justify-content:center; background:var(--bg-deep); background-image:radial-gradient(ellipse 60% 40% at 20% 20%,rgba(0,212,170,.04) 0%,transparent 70%),radial-gradient(ellipse 50% 30% at 80% 80%,color-mix(in srgb, var(--accent-secondary) 4%, transparent) 0%,transparent 70%); }
